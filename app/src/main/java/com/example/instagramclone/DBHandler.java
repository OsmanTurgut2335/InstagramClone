...
public class DBHandler extends SQLiteOpenHelper {
    ...
    private static final String POST_TABLE_NAME = "Asmın";

    private static final String ARTISTNAME_COL= "Artist Name";
    private static final String ARTNAME_COL = "ArtName";

    private static final String Artyear = "ArtYear";
    private static final String Password = "Password";
    private static final String Username = "Username";

    private static final String artUrl ="Art Url";
